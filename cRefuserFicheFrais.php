...
$req1=MoisFicheFraisRefusee($idConnexion, obtenirIdUserConnecte(), $mois);
            $ligne = mysql_query($req1, $idConnexion);
            $res1 = mysql_fetch_assoc($ligne);
                $moisR = $res1["mois"];
				echo "$moisr=". $moisR;
while ( is_array($res1) ) {
...
?>
  ...
  <div id="contenu">
      <h2>Renseigner ma fiche de frais du mois de <?php echo obtenirLibelleMois(intval(substr($moisR,4,2))) . " " . substr($mois,0,4); ?></h2>
<?php
...
<?php
      ...
      <?php          
            ...
            $req = obtenirReqEltsForfaitFicheFrais($moisR, obtenirIdUserConnecte());
...
<?php          
          ...
          $req = obtenirReqEltsHorsForfaitFicheFrais($moisR, obtenirIdUserConnecte());
...
<?php
 ...
 ?>
  ...
  <div id="contenu">
  <?php /**
MoisFicheFraisRefusee($idConnexion, obtenirIdUserConnecte());
?>
